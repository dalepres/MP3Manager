...
namespace Preston.Media
{
    ...
    {
        private List<ID3GenreItem> genres = new List<ID3GenreItem>();

        public ID3GenreItem[] GetGenreList()
        {
            return Genres;
        }
        ...
        public ID3GenreItem[] Genres
            //List<ID3GenreItem> Genres
        {
            get
            {
        ...
        public ID3GenreItem GetGenreItem(int genreId)
        {
        ...
        public ID3GenreItem GetGenreItem(string genre)
        {
            for (int count = 0; count < Genres.Length; count++)
            {
