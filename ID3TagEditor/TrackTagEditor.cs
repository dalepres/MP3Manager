...
#region Properties
        ...
        private void DisplayID3Tags()
        {
            ...
            if (v1Tag == null)
            {
                cbTags.Items.Add(Properties.Resources.NewV1TagPrompt);
            }

            if (v2Tags.Count == 0 && v22Tag == null)
            {
                cbTags.Items.Add(Properties.Resources.NewV2TagPrompt);
            }
        ...
        private void btnOk_Click(object sender, EventArgs e)
        {
            ...
            Mp3File file = new Mp3File(this.lblFileName.Text);
            if (file != null)
            {
