...
{
    public partial class ID3TagRawViewerUC : UserControl
    {
        ByteViewer byteViewer;
        object id3Tag;

        public ID3TagRawViewerUC()
        {
            InitializeComponent();
        ...
        private void lblFrameDescription_TextChanged(object sender, EventArgs e)
        {
            btnDeleteFrame.Left = lblFrameDescription.Left + lblFrameDescription.Width + 4;
        }
